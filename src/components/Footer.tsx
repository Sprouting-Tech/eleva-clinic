  ...
  return (
    <footer className="mt-2 text-sm bg-gradient-to-t from-[#FFE9E5] to-[#FFFFFF]">
      <div className="grid gap-6 py-10 md:grid-cols-4 max-w-[1280px] mx-auto">
        {/* Clinic IconxInfo */}
        <section className="hidden md:block flex flex-col justify-center items-center ">
        ...
        <div className="flex justify-center mb-1 block md:hidden">
          <Image
            src="/images/image 1.png"
            alt="Eleva Clinic Logo"
            width={150}
        ...
        <section className="block md:hidden flex flex-col justify-center items-center ">
          <div className="flex flex-col items-center mb-4">
            <Image
