...
export default function About() {
  ...
  return (
    <>
      <section className="bg-gradient-to-b from-[#FFE9E5] to-[#f9f4f2] py-16">
        <div className="max-w-[1024px] mx-auto px-4 items-center">
          ...
          <div className="text-center">
            ...
            <p className="leading-relaxed text-justify mb-5">
              ...
              eius error aliquam similique odio, doloremque ipsa non ipsam
              quaerat vero ducimus quia a? Odit possimus dolor eum rem?
              Veritatis facilis blanditiis dolor minima numquam quas officia
              dignissimos nostrum molestias dolore ab, temporibus earum porro
              accusamus tempora unde ea, similique perspiciatis.
            </p>
            <p className="leading-relaxed text-justify mb-1">
              Lorem ipsum dolor sit amet, consectetur adipisicing elit. Commodi
              in voluptas veniam pariatur ullam amet aliquam nostrum? Eum
              obcaecati magni ipsum odio praesentium numquam cum blanditiis
              soluta cumque nemo minima, ducimus iste? Suscipit, beatae quae
              quos at facere dicta ab. Ullam perspiciatis ratione animi tempora
              quod, illum possimus dignissimos! Corrupti!
            </p>
          </div>
        </div>
      </section>
